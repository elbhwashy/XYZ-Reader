...
public class ItemsProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        final com.udacity.xyzreader.data.SelectionBuilder builder = buildSelection(uri);
    ...
    private com.udacity.xyzreader.data.SelectionBuilder buildSelection(Uri uri) {
        final com.udacity.xyzreader.data.SelectionBuilder builder = new com.udacity.xyzreader.data.SelectionBuilder();
        final int match = sUriMatcher.match(uri);
        return buildSelection(uri, match, builder);
    }

    private com.udacity.xyzreader.data.SelectionBuilder buildSelection(Uri uri, int match, com.udacity.xyzreader.data.SelectionBuilder builder) {
